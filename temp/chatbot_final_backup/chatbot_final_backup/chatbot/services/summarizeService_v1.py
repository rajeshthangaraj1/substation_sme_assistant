...
class SummarizeService:
    ...
    def buildContext(self, user_input: str, user_id: str, session_id: str, session_state):
                        ...
                        to the correct specialist agent based strictly on the conditions below:
                            ...
                            1. FIRST CHECK - Document Uploaded? {context['document_uploaded']}
                               ...
                               - If YES:
                                   ...
                                   b. Else If Question References Document? {"document" in context['query']} Route to Document Analysis Specialist
                                   c. Else → Route to General Chat Agent
        ...
        # Ã¢Å“â€¦ Corrected Autonomous Task Configuration
        def create_autonomous_task(user_query: str):
            has_document = g_collection is not None
            # is_sql_query = any(
            ...
            return Task(
                description=f"""Analyze and process the user query:
                            ...
                            1. if summary keywords and document exists → Summarizer
                            2. Else if document exists and query references content → Document Analyst
        ...
        try:
            ...
            # Ã¢Å“â€¦ Directly return the tool output if it's already in session state
